...
|------|-----|-----------|-------|
| 1 | Mon | Repo + skeletons + `common.h` | Member 1 |
| 1 | Tue | `page_table` + `workload` working | Member 2 + 1 |
| 1 | Wed | FIFO + Random | Member 2 |
| 1 | Thu | LRU | Member 3 |
| 1 | Fri | LFU + MFU + dispatcher | Member 4 |
| 2 | Mon | Simulator engine integrates all algos | Member 5 |
| 2 | Tue | Stats output + memory map verified | Member 5 + 2 |
| 2 | Wed | Final 5×5 experiment, collect `output.txt` | Member 1 |
| 2 | Thu | Each member writes their report section | All |
| 2 | Fri | Final review, submit to Camino | Member 1 |
